 ...
 * - Desktop: Logo | Collection | About | Cart (simple links, no dropdowns)
 * - Mobile: Hamburger | Logo | Cart (hamburger opens simple menu)
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-white border-gray-200">
      ...
      {/* Mobile Navigation Menu - Simple links */}
      <div
        className={`md:hidden overflow-hidden ${
          mobileMenuOpen
            ? 'max-h-48 opacity-100 transition-all duration-300 ease-out'
